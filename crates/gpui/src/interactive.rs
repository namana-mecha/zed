...
/// A touch down event from the platform
#[derive(Clone, Debug, Default)]
pub struct TouchDownEvent {
    ...
    /// The modifiers that were held down when touched
    pub modifiers: Modifiers,

    /// The number of times this location has been tapped
    pub tap_count: usize,
}

impl Sealed for TouchDownEvent {}
impl InputEvent for TouchDownEvent {
    fn to_platform_input(self) -> PlatformInput {
        PlatformInput::TouchDown(self)
    }
}

/// A touch move event from the platform
#[derive(Clone, Debug, Default)]
pub struct TouchMoveEvent {
    ...
    /// The modifiers that were held down during move
    pub modifiers: Modifiers,
}

impl Sealed for TouchMoveEvent {}
impl InputEvent for TouchMoveEvent {
    fn to_platform_input(self) -> PlatformInput {
        PlatformInput::TouchMove(self)
    }
}

/// A touch up event from the platform
#[derive(Clone, Debug, Default)]
pub struct TouchUpEvent {
    ...
    /// The modifiers that were held down when released
    pub modifiers: Modifiers,
...
impl Sealed for TouchUpEvent {}
impl InputEvent for TouchUpEvent {
    fn to_platform_input(self) -> PlatformInput {
        PlatformInput::TouchUp(self)
    }
}

/// A touch event from the platform.
pub trait TouchEvent: InputEvent {}

impl TouchEvent for TouchDownEvent {}
impl TouchEvent for TouchMoveEvent {}
impl TouchEvent for TouchUpEvent {}
...
impl PlatformInput {
    pub(crate) fn mouse_event(&self) -> Option<&dyn Any> {
        match self {
            ...
            PlatformInput::TouchDown(event) => Some(event),
            PlatformInput::TouchMove(event) => Some(event),
            PlatformInput::TouchUp(event) => Some(event),
        }
    }
    ...
    pub(crate) fn keyboard_event(&self) -> Option<&dyn Any> {
        match self {
            ...
            PlatformInput::TouchDown(_) => None,
            PlatformInput::TouchMove(_) => None,
            PlatformInput::TouchUp(_) => None,
        }
    }
}
